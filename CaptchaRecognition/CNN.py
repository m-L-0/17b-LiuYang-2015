...
with tf.Session() as sess:
    ...
    image, label = read_data('tfrecords/captcha_train*')
    ...
    v_img, v_lab = read_data('tfrecords/captcha_validation')
    ...
    for i in range(100):
        ...
        if acc > 0.9 and v_accurary > 0.9:
            save_path = saver.save(sess, "/home/miles/CaptchaRecognition/model/model.ckpt")
    coord.request_stop()
    coord.join(thread)